# <a href="#" name="S-A"></a>A: Architectural ideas

This section contains ideas about higher-level architectural ideas and libraries.

Architectural rule summary:

* [A.1: Separate stable code from less stable code](/A#Ra-stable)

* [A.2: Express potentially reusable parts as a library](/A#Ra-lib)

* [A.4: There should be no cycles among libraries](/A#Ra-dag)
...
### <a href="#" name="Ra-stable"></a>A.1: Separate stable code from less stable code

Isolating less stable code facilitates its unit testing, interface improvement, refactoring, and eventual deprecation.

### <a href="#" name="Ra-lib"></a>A.2: Express potentially reusable parts as a library
...
### <a href="#" name="Ra-dag"></a>A.4: There should be no cycles among libraries
