...
The list of contributors is [here](/stdlib#SS-ack).
...
* For a more-or-less up-to-date to-do list see: [To-do: Unclassified proto-rules](/stdlib#S-unclassified)


You can [read an explanation of the scope and structure of this Guide](/abstract#S-abstract) or just jump straight in:
