# <a href="#" name="S-resource"></a>R: Resource management
...
* Resource management rule summary:
  ...
  * [R.1: Manage resources automatically using resource handles and RAII (Resource Acquisition Is Initialization)](/resource#Rr-raii)

  * [R.2: In interfaces, use raw pointers to denote individual objects (only)](/resource#Rr-use-ptr)

  * [R.3: A raw pointer (a `T*`) is non-owning](/resource#Rr-ptr)

  * [R.4: A raw reference (a `T&`) is non-owning](/resource#Rr-ref)

  * [R.5: Prefer scoped objects, don't heap-allocate unnecessarily](/resource#Rr-scoped)

  * [R.6: Avoid non-`const` global variables](/resource#Rr-global)


* Allocation and deallocation rule summary:

  * [R.10: Avoid `malloc()` and `free()`](/resource#Rr-mallocfree)

  * [R.11: Avoid calling `new` and `delete` explicitly](/resource#Rr-newdelete)

  * [R.12: Immediately give the result of an explicit resource allocation to a manager object](/resource#Rr-immediate-alloc)

  * [R.13: Perform at most one explicit resource allocation in a single expression statement](/resource#Rr-single-alloc)

  * [R.14: Avoid `[]` parameters, prefer `span`](/resource#Rr-ap)

  * [R.15: Always overload matched allocation/deallocation pairs](/resource#Rr-pair)


* <a href="#" name="Rr-summary-smartptrs"></a>Smart pointer rule summary:

  * [R.20: Use `unique_ptr` or `shared_ptr` to represent ownership](/resource#Rr-owner)

  * [R.21: Prefer `unique_ptr` over `shared_ptr` unless you need to share ownership](/resource#Rr-unique)
  ...
  * [R.30: Take smart pointers as parameters only to explicitly express lifetime semantics](/resource#Rr-smartptrparam)

  * [R.31: If you have non-`std` smart pointers, follow the basic pattern from `std`](/resource#Rr-smart)

  * [R.32: Take a `unique_ptr<widget>` parameter to express that a function assumes ownership of a `widget`](/resource#Rr-uniqueptrparam)

  * [R.33: Take a `unique_ptr<widget>&` parameter to express that a function reseats the `widget`](/resource#Rr-reseat)

  * [R.34: Take a `shared_ptr<widget>` parameter to express shared ownership](/resource#Rr-sharedptrparam-owner)

  * [R.35: Take a `shared_ptr<widget>&` parameter to express that a function might reseat the shared pointer](/resource#Rr-sharedptrparam)

  * [R.36: Take a `const shared_ptr<widget>&` parameter to express that it might retain a reference count to the object ???](/resource#Rr-sharedptrparam-const)

  * [R.37: Do not pass a pointer or reference obtained from an aliased smart pointer](/resource#Rr-smartptrget)


### <a href="#" name="Rr-raii"></a>R.1: Manage resources automatically using resource handles and RAII (Resource Acquisition Is Initialization)
...
Where a resource is "ill-behaved" in that it isn't represented as a class with a destructor, wrap it in a class or use [`finally`](/errors#Re-finally)


**See also**: [RAII](/errors#Re-raii)


### <a href="#" name="Rr-use-ptr"></a>R.2: In interfaces, use raw pointers to denote individual objects (only)
...
### <a href="#" name="Rr-ptr"></a>R.3: A raw pointer (a `T*`) is non-owning
...
In addition to suffering from the problem from [leak](#???), this adds a spurious allocation and deallocation operation, and is needlessly verbose. If Gadget is cheap to move out of a function (i.e., is small or has an efficient move operation), just return it "by value" (see ["out" return values](/functions#Rf-out)):
...
### <a href="#" name="Rr-ref"></a>R.4: A raw reference (a `T&`) is non-owning
...
**See also**: [The raw pointer rule](/resource#Rr-ptr)


##### Enforcement

See [the raw pointer rule](/resource#Rr-ptr)


### <a href="#" name="Rr-scoped"></a>R.5: Prefer scoped objects, don't heap-allocate unnecessarily
...
### <a href="#" name="Rr-global"></a>R.6: Avoid non-`const` global variables

See [I.2](/interfaces#Ri-global)


## <a href="#" name="SS-alloc"></a>R.alloc: Allocation and deallocation

### <a href="#" name="Rr-mallocfree"></a>R.10: Avoid `malloc()` and `free()`
...
### <a href="#" name="Rr-newdelete"></a>R.11: Avoid calling `new` and `delete` explicitly
...
### <a href="#" name="Rr-immediate-alloc"></a>R.12: Immediately give the result of an explicit resource allocation to a manager object
...
### <a href="#" name="Rr-single-alloc"></a>R.13: Perform at most one explicit resource allocation in a single expression statement
...
### <a href="#" name="Rr-ap"></a>R.14: Avoid `[]` parameters, prefer `span`
...
### <a href="#" name="Rr-pair"></a>R.15: Always overload matched allocation/deallocation pairs
...
## <a href="#" name="SS-smart"></a>R.smart: Smart pointers

### <a href="#" name="Rr-owner"></a>R.20: Use `unique_ptr` or `shared_ptr` to represent ownership
...
### <a href="#" name="Rr-unique"></a>R.21: Prefer `unique_ptr` over `shared_ptr` unless you need to share ownership
...
### <a href="#" name="Rr-make_shared"></a>R.22: Use `make_shared()` to make `shared_ptr`s
...
### <a href="#" name="Rr-make_unique"></a>R.23: Use `make_unique()` to make `unique_ptr`s
...
### <a href="#" name="Rr-weak_ptr"></a>R.24: Use `std::weak_ptr` to break cycles of `shared_ptr`s
...
### <a href="#" name="Rr-smartptrparam"></a>R.30: Take smart pointers as parameters only to explicitly express lifetime semantics

See [F.7](/functions#Rf-smart).


### <a href="#" name="Rr-smart"></a>R.31: If you have non-`std` smart pointers, follow the basic pattern from `std`
...
Both cases are an error under the [`sharedptrparam` guideline](/resource#Rr-smartptrparam):
...
### <a href="#" name="Rr-uniqueptrparam"></a>R.32: Take a `unique_ptr<widget>` parameter to express that a function assumes ownership of a `widget`
...
### <a href="#" name="Rr-reseat"></a>R.33: Take a `unique_ptr<widget>&` parameter to express that a function reseats the`widget`
...
### <a href="#" name="Rr-sharedptrparam-owner"></a>R.34: Take a `shared_ptr<widget>` parameter to express shared ownership
...
### <a href="#" name="Rr-sharedptrparam"></a>R.35: Take a `shared_ptr<widget>&` parameter to express that a function might reseat the shared pointer
...
### <a href="#" name="Rr-sharedptrparam-const"></a>R.36: Take a `const shared_ptr<widget>&` parameter to express that it might retain a reference count to the object ???
...
### <a href="#" name="Rr-smartptrget"></a>R.37: Do not pass a pointer or reference obtained from an aliased smart pointer
