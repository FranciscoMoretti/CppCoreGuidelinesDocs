# <a href="#" name="S-performance"></a>Per: Performance
...
* [(Per.1: Don't optimize without reason)](/performance#Rper-reason)
* [(Per.2: Don't optimize prematurely)](/performance#Rper-Knuth)
* [(Per.3: Don't optimize something that's not performance critical)](/performance#Rper-critical)
* [(Per.4: Don't assume that complicated code is necessarily faster than simple code)](/performance#Rper-simple)
* [(Per.5: Don't assume that low-level code is necessarily faster than high-level code)](/performance#Rper-low)
* [(Per.6: Don't make claims about performance without measurements)](/performance#Rper-measure)
* [(Per.7: Design to enable optimization)](/performance#Rper-efficiency)
* [(Per.10: Rely on the static type system)](/performance#Rper-type)
* [(Per.11: Move computation from run time to compile time)](/performance#Rper-Comp)
* [(Per.12: Eliminate redundant aliases)](/performance#Rper-alias)
* [(Per.13: Eliminate redundant indirections)](/performance#Rper-indirect)
* [(Per.14: Minimize the number of allocations and deallocations)](/performance#Rper-alloc)
* [(Per.15: Do not allocate on a critical branch)](/performance#Rper-alloc0)
* [(Per.16: Use compact data structures)](/performance#Rper-compact)
* [(Per.17: Declare the most used member of a time-critical struct first)](/performance#Rper-struct)
* [(Per.18: Space is time)](/performance#Rper-space)
* [(Per.19: Access memory predictably)](/performance#Rper-access)
* [(Per.30: Avoid context switches on the critical path)](/performance#Rper-context)

### <a href="#" name="Rper-reason"></a>Per.1: Don't optimize without reason
...
### <a href="#" name="Rper-Knuth"></a>Per.2: Don't optimize prematurely
...
### <a href="#" name="Rper-critical"></a>Per.3: Don't optimize something that's not performance critical
...
### <a href="#" name="Rper-simple"></a>Per.4: Don't assume that complicated code is necessarily faster than simple code
...
### <a href="#" name="Rper-low"></a>Per.5: Don't assume that low-level code is necessarily faster than high-level code
...
### <a href="#" name="Rper-measure"></a>Per.6: Don't make claims about performance without measurements
...
### <a href="#" name="Rper-efficiency"></a>Per.7: Design to enable optimization
...
Premature optimization is said to be [(the root of all evil)](/performance#Rper-Knuth), but that's not a reason to despise performance.
...
* Information passing:
  Prefer clean [(interfaces)](/interfaces#S-interfaces) carrying sufficient information for later improvement of implementation.
  Note that information flows into and out of an implementation through the interfaces we provide.
* Compact data: By default, [((use compact data)](/performance#Rper-compact), such as `std::vector` and [access it in a systematic fashion)](/performance#Rper-access).
...
* Function argument passing and return:
  ...
  Use [(conventional ways)](/functions#Rf-conventional) of passing information through an interface;
...
* Libraries:
  ...
  The [(standard library)](/stdlib#S-stdlib) is a good first place to look for inspiration.
* Isolation:
...
A need for efficiency does not imply a need for [(low-level code)](/performance#Rper-low).
...
This rule does not contradict the [(Don't optimize prematurely)](/performance#Rper-Knuth) rule.
...
### <a href="#" name="Rper-type"></a>Per.10: Rely on the static type system
...
### <a href="#" name="Rper-Comp"></a>Per.11: Move computation from run time to compile time
...
### <a href="#" name="Rper-alias"></a>Per.12: Eliminate redundant aliases

???

### <a href="#" name="Rper-indirect"></a>Per.13: Eliminate redundant indirections

???

### <a href="#" name="Rper-alloc"></a>Per.14: Minimize the number of allocations and deallocations

???

### <a href="#" name="Rper-alloc0"></a>Per.15: Do not allocate on a critical branch

???

### <a href="#" name="Rper-compact"></a>Per.16: Use compact data structures
...
### <a href="#" name="Rper-struct"></a>Per.17: Declare the most used member of a time-critical struct first

???

### <a href="#" name="Rper-space"></a>Per.18: Space is time
...
### <a href="#" name="Rper-access"></a>Per.19: Access memory predictably
...
### <a href="#" name="Rper-context"></a>Per.30: Avoid context switches on the critical path
