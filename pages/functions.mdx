...
We can catch many common cases of dangling pointers statically (see [lifetime safety profile](/stdlib#SS-lifetime)). Function arguments naturally live for the lifetime of the function call, and so have fewer lifetime problems.
...
**See also**: [Support library](/stdlib#S-gsl)
...
The [lifetime safety profile](/stdlib#SS-lifetime) will (when completely implemented) catch such problems.
