# <a href="#" name="S-expr"></a>ES: Expressions and statements
...
For naming, commenting, and indentation rules, see [(NL: Naming and layout)](/naming#S-naming).

General rules:

* [(ES.1: Prefer the standard library to other libraries and to "handcrafted code")](/expr#Res-lib)
* [(ES.2: Prefer suitable abstractions to direct use of language features)](/expr#Res-abstr)
* [(ES.3: Don't repeat yourself, avoid redundant code)](/expr#Res-DRY)

Declaration rules:

* [(ES.5: Keep scopes small)](/expr#Res-scope)
* [(ES.6: Declare names in for-statement initializers and conditions to limit scope)](/expr#Res-cond)
* [(ES.7: Keep common and local names short, and keep uncommon and non-local names longer)](/expr#Res-name-length)
* [(ES.8: Avoid similar-looking names)](/expr#Res-name-similar)
* [(ES.9: Avoid `ALL_CAPS` names)](/expr#Res-not-CAPS)
* [(ES.10: Declare one name (only) per declaration)](/expr#Res-name-one)
* [(ES.11: Use `auto` to avoid redundant repetition of type names)](/expr#Res-auto)
* [(ES.12: Do not reuse names in nested scopes)](/expr#Res-reuse)
* [(ES.20: Always initialize an object)](/expr#Res-always)
* [(ES.21: Don't introduce a variable (or constant) before you need to use it)](/expr#Res-introduce)
* [(ES.22: Don't declare a variable until you have a value to initialize it with)](/expr#Res-init)
* [(ES.23: Prefer the `{}`-initializer syntax)](/expr#Res-list)
* [(ES.24: Use a `unique_ptr<T>` to hold pointers)](/expr#Res-unique)
* [(ES.25: Declare an object `const` or `constexpr` unless you want to modify its value later on)](/expr#Res-const)
* [(ES.26: Don't use a variable for two unrelated purposes)](/expr#Res-recycle)
* [(ES.27: Use `std::array` or `stack_array` for arrays on the stack)](/expr#Res-stack)
* [(ES.28: Use lambdas for complex initialization, especially of `const` variables)](/expr#Res-lambda-init)
* [(ES.30: Don't use macros for program text manipulation)](/expr#Res-macros)
* [(ES.31: Don't use macros for constants or "functions")](/expr#Res-macros2)
* [ES.32: Use `ALL_CAPS` for all macro names](#Res-ALL_CAPS)
* [(ES.33: If you must use macros, give them unique names)](/expr#Res-MACROS)
* [(ES.34: Don't define a (C-style) variadic function)](/expr#Res-ellipses)

Expression rules:

* [(ES.40: Avoid complicated expressions)](/expr#Res-complicated)
* [(ES.41: If in doubt about operator precedence, parenthesize)](/expr#Res-parens)
* [(ES.42: Keep use of pointers simple and straightforward)](/expr#Res-ptr)
* [(ES.43: Avoid expressions with undefined order of evaluation)](/expr#Res-order)
* [(ES.44: Don't depend on order of evaluation of function arguments)](/expr#Res-order-fct)
* [(ES.45: Avoid "magic constants"; use symbolic constants)](/expr#Res-magic)
* [(ES.46: Avoid narrowing conversions)](/expr#Res-narrowing)
* [(ES.47: Use `nullptr` rather than `0` or `NULL`)](/expr#Res-nullptr)
* [(ES.48: Avoid casts)](/expr#Res-casts)
* [(ES.49: If you must use a cast, use a named cast)](/expr#Res-casts-named)
* [(ES.50: Don't cast away `const`)](/expr#Res-casts-const)
* [(ES.55: Avoid the need for range checking)](/expr#Res-range-checking)
* [(ES.56: Write `std::move()` only when you need to explicitly move an object to another scope)](/expr#Res-move)
* [(ES.60: Avoid `new` and `delete` outside resource management functions)](/expr#Res-new)
* [(ES.61: Delete arrays using `delete[]` and non-arrays using `delete`)](/expr#Res-del)
* [(ES.62: Don't compare pointers into different arrays)](/expr#Res-arr2)
* [(ES.63: Don't slice)](/expr#Res-slice)
* [(ES.64: Use the `T{e}`notation for construction)](/expr#Res-construct)
* [(ES.65: Don't dereference an invalid pointer)](/expr#Res-deref)

Statement rules:

* [(ES.70: Prefer a `switch`-statement to an `if`-statement when there is a choice)](/expr#Res-switch-if)
* [(ES.71: Prefer a range-`for`-statement to a `for`-statement when there is a choice)](/expr#Res-for-range)
* [(ES.72: Prefer a `for`-statement to a `while`-statement when there is an obvious loop variable)](/expr#Res-for-while)
* [(ES.73: Prefer a `while`-statement to a `for`-statement when there is no obvious loop variable)](/expr#Res-while-for)
* [(ES.74: Prefer to declare a loop variable in the initializer part of a `for`-statement)](/expr#Res-for-init)
* [(ES.75: Avoid `do`-statements)](/expr#Res-do)
* [(ES.76: Avoid `goto`)](/expr#Res-goto)
* [(ES.77: Minimize the use of `break` and `continue` in loops)](/expr#Res-continue)
* [(ES.78: Don't rely on implicit fallthrough in `switch` statements)](/expr#Res-break)
* [(ES.79: Use `default` to handle common cases (only))](/expr#Res-default)
* [(ES.84: Don't try to declare a local variable with no name)](/expr#Res-noname)
* [(ES.85: Make empty statements visible)](/expr#Res-empty)
* [(ES.86: Avoid modifying loop control variables inside the body of raw for-loops)](/expr#Res-loop-counter)
* [(ES.87: Don't add redundant `==` or `!=` to conditions)](/expr#Res-if)

Arithmetic rules:

* [(ES.100: Don't mix signed and unsigned arithmetic)](/expr#Res-mix)
* [(ES.101: Use unsigned types for bit manipulation)](/expr#Res-unsigned)
* [(ES.102: Use signed types for arithmetic)](/expr#Res-signed)
* [(ES.103: Don't overflow)](/expr#Res-overflow)
* [(ES.104: Don't underflow)](/expr#Res-underflow)
* [(ES.105: Don't divide by integer zero)](/expr#Res-zero)
* [(ES.106: Don't try to avoid negative values by using `unsigned`)](/expr#Res-nonnegative)
* [(ES.107: Don't use `unsigned` for subscripts, prefer `gsl::index`)](/expr#Res-subscripts)

### <a href="#" name="Res-lib"></a>ES.1: Prefer the standard library to other libraries and to "handcrafted code"
...
### <a href="#" name="Res-abstr"></a>ES.2: Prefer suitable abstractions to direct use of language features
...
### <a href="#" name="Res-DRY"></a>ES.3: Don't repeat yourself, avoid redundant code
...
**See also**: [((SL.1)](/stdlib#Rsl-lib), [ES.11)](/expr#Res-auto)
...
### <a href="#" name="Res-scope"></a>ES.5: Keep scopes small
...
### <a href="#" name="Res-cond"></a>ES.6: Declare names in for-statement initializers and conditions to limit scope
...
**See also**: [(Don't use a variable for two unrelated purposes)](/expr#Res-recycle)
...
### <a href="#" name="Res-name-length"></a>ES.7: Keep common and local names short, and keep uncommon and non-local names longer
...
### <a href="#" name="Res-name-similar"></a>ES.8: Avoid similar-looking names
...
### <a href="#" name="Res-not-CAPS"></a>ES.9: Avoid `ALL_CAPS` names
...
### <a href="#" name="Res-name-one"></a>ES.10: Declare one name (only) per declaration
...
### <a href="#" name="Res-auto"></a>ES.11: Use `auto` to avoid redundant repetition of type names
...
### <a href="#" name="Res-reuse"></a>ES.12: Do not reuse names in nested scopes
...
### <a href="#" name="Res-always"></a>ES.20: Always initialize an object
...
we can eliminate it by using a lambda [(ES.28)](/expr#Res-lambda-init):
...
**See also**: [(ES.28)](/expr#Res-lambda-init)
...
### <a href="#" name="Res-introduce"></a>ES.21: Don't introduce a variable (or constant) before you need to use it
...
### <a href="#" name="Res-init"></a>ES.22: Don't declare a variable until you have a value to initialize it with
...
For initializers of moderate complexity, including for `const` variables, consider using a lambda to express the initializer; see [(ES.28)](/expr#Res-lambda-init).
...
### <a href="#" name="Res-list"></a>ES.23: Prefer the `{}`-initializer syntax
...
### <a href="#" name="Res-unique"></a>ES.24: Use a `unique_ptr<T>` to hold pointers
...
### <a href="#" name="Res-const"></a>ES.25: Declare an object `const` or `constexpr` unless you want to modify its value later on
...
### <a href="#" name="Res-recycle"></a>ES.26: Don't use a variable for two unrelated purposes
...
### <a href="#" name="Res-stack"></a>ES.27: Use `std::array` or `stack_array` for arrays on the stack
...
### <a href="#" name="Res-lambda-init"></a>ES.28: Use lambdas for complex initialization, especially of `const` variables
...
### <a href="#" name="Res-macros"></a>ES.30: Don't use macros for program text manipulation
...
### <a href="#" name="Res-macros2"></a>ES.31: Don't use macros for constants or "functions"
...
### <a href="#" name="Res-ALL_CAPS"></a>ES.32: Use `ALL_CAPS` for all macro names
...
### <a href="#" name="Res-MACROS"></a>ES.33: If you must use macros, give them unique names
...
Avoid macros if you can: [((ES.30)](/expr#Res-macros), [ES.31)](/expr#Res-macros2), and [ES.32](#Res-ALL_CAPS).
...
### <a href="#" name="Res-ellipses"></a> ES.34: Don't define a (C-style) variadic function
...
### <a href="#" name="Res-complicated"></a>ES.40: Avoid complicated expressions
...
(left-to-right except right-to-left in assignments, and the order of evaluation of function arguments is unspecified; [(see ES.43)](/expr#Res-order)),
...
### <a href="#" name="Res-parens"></a>ES.41: If in doubt about operator precedence, parenthesize
...
### <a href="#" name="Res-ptr"></a>ES.42: Keep use of pointers simple and straightforward
...
Pointers should [(only refer to single objects)](/interfaces#Ri-array).
...
This rule is part of the [(bounds-safety profile)](/profile#SS-bounds).

### <a href="#" name="Res-order"></a>ES.43: Avoid expressions with undefined order of evaluation
...
### <a href="#" name="Res-order-fct"></a>ES.44: Don't depend on order of evaluation of function arguments
...
### <a href="#" name="Res-magic"></a>ES.45: Avoid "magic constants"; use symbolic constants
...
### <a href="#" name="Res-narrowing"></a>ES.46: Avoid lossy (narrowing, truncating) arithmetic conversions
...
### <a href="#" name="Res-nullptr"></a>ES.47: Use `nullptr` rather than `0` or `NULL`
...
### <a href="#" name="Res-casts"></a>ES.48: Avoid casts
...
The [(type profile)](/profile#Pro-type-reinterpretcast) bans `reinterpret_cast` and C-style casts.
...
* Flag functional style casts using `Type(value)`. Use `Type{value}` instead which is not narrowing. (See [(ES.64)](/expr#Res-construct).)
* Flag [(identity casts)](/profile#Pro-type-identitycast) between pointer types, where the source and target types are the same (#Pro-type-identitycast).
* Flag an explicit pointer cast that could be [(implicit)](/profile#Pro-type-implicitpointercast).

### <a href="#" name="Res-casts-named"></a>ES.49: If you must use a cast, use a named cast
...
* Flag all C-style casts, including to `void`.
* Flag functional style casts using `Type(value)`. Use `Type{value}` instead which is not narrowing. (See [(ES.64)](/expr#Res-construct).)
* The [(type profile)](/profile#Pro-type-reinterpretcast) bans `reinterpret_cast`.
* The [(type profile)](/profile#Pro-type-arithmeticcast) warns when using `static_cast` between arithmetic types.

### <a href="#" name="Res-casts-const"></a>ES.50: Don't cast away `const`
...
* Flag `const_cast`s.
* This rule is part of the [(type-safety profile)](/profile#Pro-type-constcast) for the related Profile.

### <a href="#" name="Res-range-checking"></a>ES.55: Avoid the need for range checking
...
### <a href="#" name="Res-move"></a>ES.56: Write `std::move()` only when you need to explicitly move an object to another scope

##### Reason

We move, rather than copy, to avoid duplication and for improved performance.

A move typically leaves behind an empty object ([(C.64)](/class#Rc-move-semantic)), which can be surprising or even dangerous, so we try to avoid moving from lvalues (they might be accessed later).
...
And after you do that, assume the object has been moved from (see [(C.64)](/class#Rc-move-semantic)) and don't read its state again until you first set it to a new value.
...
Never write `std::move()` on a const object, it is silently transformed into a copy (see Item 23 in [(Meyers15)](/unclassified#Meyers15))
...
### <a href="#" name="Res-new"></a>ES.60: Avoid `new` and `delete` outside resource management functions
...
**See also**: [(R: Resource management)](/resource#S-resource)

##### Enforcement

Flag naked `new`s and naked `delete`s.

### <a href="#" name="Res-del"></a>ES.61: Delete arrays using `delete[]` and non-arrays using `delete`
...
This example not only violates the [(no naked `new` rule)](/expr#Res-new) as in the previous example, it has many more problems.
...
### <a href="#" name="Res-arr2"></a>ES.62: Don't compare pointers into different arrays
...
### <a href="#" name="Res-slice"></a>ES.63: Don't slice
...
The first defense against this is to [(define the base class `Shape` not to allow this)](/class#Rc-copy-virtual).
...
### <a href="#" name="Res-construct"></a>ES.64: Use the `T{e}`notation for construction
...
[((Avoid casts)](/expr#Res-casts) (explicit type conversion) and if you must [prefer named casts)](/expr#Res-casts-named).
...
The construction notation is the most general [(initializer notation)](/expr#Res-list).
...
### <a href="#" name="Res-deref"></a>ES.65: Don't dereference an invalid pointer
...
This is a major part of the discussion of [(C++'s model for type- and resource-safety)](/unclassified#Stroustrup15).

**See also**:

* Use [(RAII)](/resource#Rr-raii) to avoid lifetime problems.
* Use [unique\_ptr](#Rf-unique_ptr) to avoid lifetime problems.
* Use [shared\_ptr](#Rf-shared_ptr) to avoid lifetime problems.
* Use [(references)](/functions#Rf-ptr-ref) when `nullptr` isn't a possibility.
* Use [(not\_null)](/functions#Rf-nullptr) to catch unexpected `nullptr` early.
* Use the [(bounds profile)](/profile#SS-bounds) to avoid range errors.
...
This rule is part of the [(lifetime safety profile)](/profile#SS-lifetime)
...
### <a href="#" name="Res-switch-if"></a>ES.70: Prefer a `switch`-statement to an `if`-statement when there is a choice
...
### <a href="#" name="Res-for-range"></a>ES.71: Prefer a range-`for`-statement to a `for`-statement when there is a choice
...
### <a href="#" name="Res-for-while"></a>ES.72: Prefer a `for`-statement to a `while`-statement when there is an obvious loop variable
...
### <a href="#" name="Res-while-for"></a>ES.73: Prefer a `while`-statement to a `for`-statement when there is no obvious loop variable
...
### <a href="#" name="Res-for-init"></a>ES.74: Prefer to declare a loop variable in the initializer part of a `for`-statement

See [(ES.6)](/expr#Res-cond)

### <a href="#" name="Res-do"></a>ES.75: Avoid `do`-statements
...
### <a href="#" name="Res-goto"></a>ES.76: Avoid `goto`
...
### <a href="#" name="Res-continue"></a>ES.77: Minimize the use of `break` and `continue` in loops
...
If you really need to break out a loop, a `break` is typically better than alternatives such as [((modifying the loop variable)](/expr#Res-loop-counter) or a [`goto`)](/expr#Res-goto):

##### Enforcement

???

### <a href="#" name="Res-break"></a>ES.78: Don't rely on implicit fallthrough in `switch` statements
...
### <a href="#" name="Res-default"></a>ES.79: Use `default` to handle common cases (only)
...
### <a href="#" name="Res-noname"></a>ES.84: Don't try to declare a local variable with no name
...
### <a href="#" name="Res-empty"></a>ES.85: Make empty statements visible
...
### <a href="#" name="Res-loop-counter"></a>ES.86: Avoid modifying loop control variables inside the body of raw for-loops
...
### <a href="#" name="Res-if"></a>ES.87: Don't add redundant `==` or `!=` to conditions
...
## <a href="#" name="SS-numbers"></a>Arithmetic

### <a href="#" name="Res-mix"></a>ES.100: Don't mix signed and unsigned arithmetic
...
This precludes consistency. Use `gsl::index` for subscripts; [(see ES.107)](/expr#Res-subscripts).
...
### <a href="#" name="Res-unsigned"></a>ES.101: Use unsigned types for bit manipulation
...
### <a href="#" name="Res-signed"></a>ES.102: Use signed types for arithmetic
...
Use `gsl::index` for subscripts; [(see ES.107)](/expr#Res-subscripts).
...
### <a href="#" name="Res-overflow"></a>ES.103: Don't overflow
...
### <a href="#" name="Res-underflow"></a>ES.104: Don't underflow
...
### <a href="#" name="Res-zero"></a>ES.105: Don't divide by integer zero
...
### <a href="#" name="Res-nonnegative"></a>ES.106: Don't try to avoid negative values by using `unsigned`
...
```cpp
unsigned area(unsigned height, unsigned width) { return height*width; } // [(see also)](/interfaces#Ri-expects)
// ...
int height;
cin >> height;
...
### <a href="#" name="Res-subscripts"></a>ES.107: Don't use `unsigned` for subscripts, prefer `gsl::index`
