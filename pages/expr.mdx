...
* Flag [identity casts](/profile#Pro-type-identitycast) between pointer types, where the source and target types are the same (/profile#Pro-type-identitycast).
...
* Use [not_null](/functions#Rf-nullptr) to catch unexpected `nullptr` early.
