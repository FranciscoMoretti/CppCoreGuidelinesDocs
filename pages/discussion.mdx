# <a href="#" name="S-discussion"></a>Appendix C: Discussion
...
### <a href="#" name="Sd-order"></a>Discussion: Define and initialize member variables in the order of member declaration
...
[(((((((\[Cline99\])](/unclassified#Cline99) §22.03-11, [\[Dewhurst03\])](/unclassified#Dewhurst03) §52-53, [\[Koenig97\])](/unclassified#Koenig97) §4, [\[Lakos96\])](/unclassified#Lakos96) §10.3.5, [\[Meyers97\])](/unclassified#Meyers97) §13, [\[Murray93\])](/unclassified#Murray93) §2.1.3, [\[Sutter00\])](/unclassified#Sutter00) §47

### <a href="#" name="Sd-init"></a>Discussion: Use of `=`, `{}`, and `()` as initializers

???

### <a href="#" name="Sd-factory"></a>Discussion: Use a factory function if you need "virtual behavior" during initialization
...
* *Use virtual base class semantics:* Language rules dictate that the constructor of the most-derived class decides which base constructor will be invoked; you can use that to your advantage. (See [(\[Taligent94\])](/unclassified#Taligent94).)
...
* Allocation is limited to `operator new`. `B` can, however, override `new` (see Items 45 and 46 in [(SuttAlex05)](/unclassified#SuttAlex05)).
...
**References**: [((((((\[Alexandrescu01\])](/unclassified#Alexandrescu01) §3, [\[Boost\])](/references#Boost), [\[Dewhurst03\])](/unclassified#Dewhurst03) §75, [\[Meyers97\])](/unclassified#Meyers97) §46, [\[Stroustrup00\])](/unclassified#Stroustrup00) §15.4.3, [\[Taligent94\])](/unclassified#Taligent94)

### <a href="#" name="Sd-dtor"></a>Discussion: Make base class destructors public and virtual, or protected and non-virtual
...
**References**: [(((((((((\[SuttAlex05\])](/unclassified#SuttAlex05) Item 50, [\[Cargill92\])](/unclassified#Cargill92) pp. 77-79, 207, [\[Cline99\])](/unclassified#Cline99) §21.06, 21.12-13, [\[Henricson97\])](/unclassified#Henricson97) pp. 110-114, [\[Koenig97\])](/unclassified#Koenig97) Chapters 4, 11, [\[Meyers97\])](/unclassified#Meyers97) §14, [\[Stroustrup00\])](/unclassified#Stroustrup00) §12.4.2, [\[Sutter02\])](/unclassified#Sutter02) §27, [\[Sutter04\])](/unclassified#Sutter04) §18

### <a href="#" name="Sd-noexcept"></a>Discussion: Usage of noexcept

???

### <a href="#" name="Sd-never-fail"></a>Discussion: Destructors, deallocation, and swap must never fail
...
> If a destructor called during stack unwinding exits with an exception, terminate is called (15.5.1). So destructors should generally catch exceptions and not let them propagate out of the destructor. --[(\[C++03\])](/unclassified#Cplusplus03) §15.2(3)
>
> No destructor operation defined in the C++ Standard Library (including the destructor of any type that is used to instantiate a standard-library template) will throw an exception. --[(\[C++03\])](/unclassified#Cplusplus03) §17.4.4.8(3)
...
**References**: [((((((\[SuttAlex05\])](/unclassified#SuttAlex05) Item 51; [\[C++03\])](/unclassified#Cplusplus03) §15.2(3), §17.4.4.8(3), [\[Meyers96\])](/unclassified#Meyers96) §11, [\[Stroustrup00\])](/unclassified#Stroustrup00) §14.4.7, §E.2-4, [\[Sutter00\])](/unclassified#Sutter00) §8, §16, [\[Sutter02\])](/unclassified#Sutter02) §18-19

## <a href="#" name="Sd-consistent"></a>Define Copy, move, and destroy consistently
...
**References**: [(((((\[SuttAlex05\])](/unclassified#SuttAlex05) Item 52; [\[Cline99\])](/unclassified#Cline99) §30.01-14, [\[Koenig97\])](/unclassified#Koenig97) §4, [\[Stroustrup00\])](/unclassified#Stroustrup00) §5.5, §10.4, [\[SuttHysl04b\])](/unclassified#SuttHysl04b)

Resource management rule summary:

* [(Provide strong resource safety; that is, never leak anything that you think of as a resource)](/discussion#Cr-safety)
* [(Never return or throw while holding a resource not owned by a handle)](/discussion#Cr-never)
* [(A "raw" pointer or reference is never a resource handle)](/discussion#Cr-raw)
* [(Never let a pointer outlive the object it points to)](/discussion#Cr-outlive)
* [(Use templates to express containers (and other resource handles))](/discussion#Cr-templates)
* [(Return containers by value (relying on move or copy elision for efficiency))](/discussion#Cr-value-return)
* [(If a class is a resource handle, it needs a constructor, a destructor, and copy and/or move operations)](/discussion#Cr-handle)
* [(If a class is a container, give it an initializer-list constructor)](/discussion#Cr-list)

### <a href="#" name="Cr-safety"></a>Discussion: Provide strong resource safety; that is, never leak anything that you think of as a resource
...
### <a href="#" name="Cr-never"></a>Discussion: Never return or throw while holding a resource not owned by a handle
...
### <a href="#" name="Cr-raw"></a>Discussion: A "raw" pointer or reference is never a resource handle
...
### <a href="#" name="Cr-outlive"></a>Discussion: Never let a pointer outlive the object it points to
...
### <a href="#" name="Cr-templates"></a>Discussion: Use templates to express containers (and other resource handles)
...
### <a href="#" name="Cr-value-return"></a>Discussion: Return containers by value (relying on move or copy elision for efficiency)
...
### <a href="#" name="Cr-handle"></a>Discussion: If a class is a resource handle, it needs a constructor, a destructor, and copy and/or move operations
...
### <a href="#" name="Cr-list"></a>Discussion: If a class is a container, give it an initializer-list constructor
