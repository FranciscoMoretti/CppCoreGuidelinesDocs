...
Any programmer using these guidelines should know the [guidelines support library](/stdlib#S-gsl), and use it appropriately.
...
* [The guidelines support library](/stdlib#S-gsl)
...
Enforcing [the lifetime safety profile](/stdlib#SS-lifetime) eliminates leaks.
...
* Look at pointers: Classify them into non-owners (the default) and owners.
  ...
  Alternatively, mark an owner as such using `owner` from [the GSL](/stdlib#S-gsl).
