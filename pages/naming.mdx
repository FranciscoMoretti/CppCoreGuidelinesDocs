# <a href="#" name="S-naming"></a>NL: Naming and layout suggestions
...
* [NL.1: Don't say in comments what can be clearly stated in code](/naming#Rl-comments)

* [NL.2: State intent in comments](/naming#Rl-comments-intent)

* [NL.3: Keep comments crisp](/naming#Rl-comments-crisp)

* [NL.4: Maintain a consistent indentation style](/naming#Rl-indent)

* [NL.5: Avoid encoding type information in names](/naming#Rl-name-type)

* [NL.7: Make the length of a name roughly proportional to the length of its scope](/naming#Rl-name-length)

* [NL.8: Use a consistent naming style](/naming#Rl-name)

* [NL.9: Use `ALL_CAPS` for macro names only](/naming#Rl-all-caps)

* [NL.10: Prefer `underscore_style` names](/naming#Rl-camel)

* [NL.11: Make literals readable](/naming#Rl-literals)

* [NL.15: Use spaces sparingly](/naming#Rl-space)

* [NL.16: Use a conventional class member declaration order](/naming#Rl-order)

* [NL.17: Use K&R-derived layout](/naming#Rl-knr)

* [NL.18: Use C++-style declarator layout](/naming#Rl-ptr)

* [NL.19: Avoid names that are easily misread](/naming#Rl-misread)

* [NL.20: Don't place two statements on the same line](/naming#Rl-stmt)

* [NL.21: Declare one name (only) per declaration](/naming#Rl-dcl)

* [NL.25: Don't use `void` as an argument type](/naming#Rl-void)

* [NL.26: Use conventional `const` notation](/naming#Rl-const)
...
### <a href="#" name="Rl-comments"></a>NL.1: Don't say in comments what can be clearly stated in code
...
### <a href="#" name="Rl-comments-intent"></a>NL.2: State intent in comments
...
### <a href="#" name="Rl-comments-crisp"></a>NL.3: Keep comments crisp
...
### <a href="#" name="Rl-indent"></a>NL.4: Maintain a consistent indentation style
...
### <a href="#" name="Rl-name-type"></a>NL.5: Avoid encoding type information in names
...
### <a href="#" name="Rl-name-length"></a>NL.7: Make the length of a name roughly proportional to the length of its scope
...
### <a href="#" name="Rl-name"></a>NL.8: Use a consistent naming style
...
### <a href="#" name="Rl-all-caps"></a>NL.9: Use `ALL_CAPS` for macro names only
...
### <a href="#" name="Rl-camel"></a>NL.10: Prefer `underscore_style` names
...
Often, you don't have a choice and must follow an established style for [consistency](/naming#Rl-name).

The need for consistency beats personal taste.

This is a recommendation for [when you have no constraints or better ideas](/naming#S-naming).
...
### <a href="#" name="Rl-literals"></a>NL.11: Make literals readable
...
### <a href="#" name="Rl-space"></a>NL.15: Use spaces sparingly
...
### <a href="#" name="Rl-order"></a>NL.16: Use a conventional class member declaration order
...
### <a href="#" name="Rl-knr"></a>NL.17: Use K&R-derived layout
...
### <a href="#" name="Rl-ptr"></a>NL.18: Use C++-style declarator layout
...
### <a href="#" name="Rl-misread"></a>NL.19: Avoid names that are easily misread
...
### <a href="#" name="Rl-stmt"></a>NL.20: Don't place two statements on the same line
...
### <a href="#" name="Rl-dcl"></a>NL.21: Declare one name (only) per declaration
...
### <a href="#" name="Rl-void"></a>NL.25: Don't use `void` as an argument type
...
### <a href="#" name="Rl-const"></a>NL.26: Use conventional `const` notation
