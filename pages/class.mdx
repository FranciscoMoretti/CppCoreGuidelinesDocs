# <a href="#" name="S-class"></a>C: Classes and class hierarchies
...
* [(C.1: Organize related data into structures (`struct`s or `class`es))](/class#Rc-org)
* [(C.2: Use `class` if the class has an invariant; use `struct` if the data members can vary independently)](/class#Rc-struct)
* [(C.3: Represent the distinction between an interface and an implementation using a class)](/class#Rc-interface)
* [(C.4: Make a function a member only if it needs direct access to the representation of a class)](/class#Rc-member)
* [(C.5: Place helper functions in the same namespace as the class they support)](/class#Rc-helper)
* [(C.7: Don't define a class or enum and declare a variable of its type in the same statement)](/class#Rc-standalone)
* [(C.8: Use `class` rather than `struct` if any member is non-public)](/class#Rc-class)
* [(C.9: Minimize exposure of members)](/class#Rc-private)

Subsections:

* [(C.concrete: Concrete types)](/class#SS-concrete)
* [(C.ctor: Constructors, assignments, and destructors)](/class#S-ctor)
* [(C.con: Containers and other resource handles)](/class#SS-containers)
* [(C.lambdas: Function objects and lambdas)](/class#SS-lambdas)
* [(C.hier: Class hierarchies (OOP))](/class#SS-hier)
* [(C.over: Overloading and overloaded operators)](/class#SS-overload)
* [(C.union: Unions)](/class#SS-union)

### <a href="#" name="Rc-org"></a>C.1: Organize related data into structures (`struct`s or `class`es)
...
### <a href="#" name="Rc-struct"></a>C.2: Use `class` if the class has an invariant; use `struct` if the data members can vary independently
...
* [(define a class with private data as `class`)](/class#Rc-class)
* [(Prefer to place the interface first in a class)](/naming#Rl-order)
* [(minimize exposure of members)](/class#Rc-private)
* [(Avoid `protected` data)](/class#Rh-protected)

##### Enforcement

Look for `struct`s with all data private and `class`es with public members.

### <a href="#" name="Rc-interface"></a>C.3: Represent the distinction between an interface and an implementation using a class
...
### <a href="#" name="Rc-member"></a>C.4: Make a function a member only if it needs direct access to the representation of a class
...
### <a href="#" name="Rc-helper"></a>C.5: Place helper functions in the same namespace as the class they support
...
This is especially important for [(overloaded operators)](/class#Ro-namespace).

##### Enforcement

* Flag global functions taking argument types from a single namespace.

### <a href="#" name="Rc-standalone"></a>C.7: Don't define a class or enum and declare a variable of its type in the same statement
...
### <a href="#" name="Rc-class"></a>C.8: Use `class` rather than `struct` if any member is non-public
...
Prefer to place the interface first in a class, [(see NL.16)](/naming#Rl-order).

##### Enforcement

Flag classes declared with `struct` if there is a `private` or `protected` member.

### <a href="#" name="Rc-private"></a>C.9: Minimize exposure of members
...
[(`protected` data is a bad idea)](/class#Rh-protected).

##### Note

Prefer the order `public` members before `protected` members before `private` members; see [(NL.16)](/naming#Rl-order).

##### Enforcement

* [(Flag protected data)](/class#Rh-protected).
* Flag mixtures of `public` and `private` data

## <a href="#" name="SS-concrete"></a>C.concrete: Concrete types

Concrete type rule summary:

* [(C.10: Prefer concrete types over class hierarchies)](/class#Rc-concrete)
* [(C.11: Make concrete types regular)](/class#Rc-regular)
* [(C.12: Don't make data members `const` or references)](/class#Rc-constref)

### <a href="#" name="Rc-concrete"></a>C.10: Prefer concrete types over class hierarchies
...
### <a href="#" name="Rc-regular"></a>C.11: Make concrete types regular
...
### <a href="#" name="Rc-constref"></a>C.12: Don't make data members `const` or references
...
## <a href="#" name="S-ctor"></a>C.ctor: Constructors, assignments, and destructors
...
* [(C.20: If you can avoid defining any default operations, do)](/class#Rc-zero)
* [(C.21: If you define or `=delete` any copy, move, or destructor function, define or `=delete` them all)](/class#Rc-five)
* [(C.22: Make default operations consistent)](/class#Rc-matched)

Destructor rules:

* [(C.30: Define a destructor if a class needs an explicit action at object destruction)](/class#Rc-dtor)
* [(C.31: All resources acquired by a class must be released by the class's destructor)](/class#Rc-dtor-release)
* [(C.32: If a class has a raw pointer (`T*`) or reference (`T&`), consider whether it might be owning)](/class#Rc-dtor-ptr)
* [(C.33: If a class has an owning pointer member, define a destructor)](/class#Rc-dtor-ptr2)
* [(C.35: A base class destructor should be either public and virtual, or protected and non-virtual)](/class#Rc-dtor-virtual)
* [(C.36: A destructor must not fail)](/class#Rc-dtor-fail)
* [(C.37: Make destructors `noexcept`)](/class#Rc-dtor-noexcept)

Constructor rules:

* [(C.40: Define a constructor if a class has an invariant)](/class#Rc-ctor)
* [(C.41: A constructor should create a fully initialized object)](/class#Rc-complete)
* [(C.42: If a constructor cannot construct a valid object, throw an exception)](/class#Rc-throw)
* [(C.43: Ensure that a copyable class has a default constructor)](/class#Rc-default0)
* [(C.44: Prefer default constructors to be simple and non-throwing)](/class#Rc-default00)
* [(C.45: Don't define a default constructor that only initializes data members; use member initializers instead)](/class#Rc-default)
* [(C.46: By default, declare single-argument constructors `explicit`)](/class#Rc-explicit)
* [(C.47: Define and initialize member variables in the order of member declaration)](/class#Rc-order)
* [(C.48: Prefer in-class initializers to member initializers in constructors for constant initializers)](/class#Rc-in-class-initializer)
* [(C.49: Prefer initialization to assignment in constructors)](/class#Rc-initialize)
* [(C.50: Use a factory function if you need "virtual behavior" during initialization)](/class#Rc-factory)
* [(C.51: Use delegating constructors to represent common actions for all constructors of a class)](/class#Rc-delegating)
* [(C.52: Use inheriting constructors to import constructors into a derived class that does not need further explicit initialization)](/class#Rc-inheriting)

Copy and move rules:

* [(C.60: Make copy assignment non-`virtual`, take the parameter by `const&`, and return by non-`const&`)](/class#Rc-copy-assignment)
* [(C.61: A copy operation should copy)](/class#Rc-copy-semantic)
* [(C.62: Make copy assignment safe for self-assignment)](/class#Rc-copy-self)
* [(C.63: Make move assignment non-`virtual`, take the parameter by `&&`, and return by non-`const&`)](/class#Rc-move-assignment)
* [(C.64: A move operation should move and leave its source in a valid state)](/class#Rc-move-semantic)
* [(C.65: Make move assignment safe for self-assignment)](/class#Rc-move-self)
* [(C.66: Make move operations `noexcept`)](/class#Rc-move-noexcept)
* [(C.67: A polymorphic class should suppress public copy/move)](/class#Rc-copy-virtual)

Other default operations rules:

* [(C.80: Use `=default` if you have to be explicit about using the default semantics)](/class#Rc-eqdefault)
* [(C.81: Use `=delete` when you want to disable default behavior (without wanting an alternative))](/class#Rc-delete)
* [(C.82: Don't call virtual functions in constructors and destructors)](/class#Rc-ctor-virtual)
* [(C.83: For value-like types, consider providing a `noexcept` swap function)](/class#Rc-swap)
* [(C.84: A `swap` must not fail)](/class#Rc-swap-fail)
* [(C.85: Make `swap` `noexcept`)](/class#Rc-swap-noexcept)
* [(C.86: Make `==` symmetric with respect of operand types and `noexcept`)](/class#Rc-eq)
* [(C.87: Beware of `==` on base classes)](/class#Rc-eq-base)
* [(C.89: Make a `hash` `noexcept`)](/class#Rc-hash)
* [(C.90: Rely on constructors and assignment operators, not memset and memcpy)](/class#Rc-memset)

## <a href="#" name="SS-defop"></a>C.defop: Default Operations
...
### <a href="#" name="Rc-zero"></a>C.20: If you can avoid defining default operations, do
...
### <a href="#" name="Rc-five"></a>C.21: If you define or `=delete` any copy, move, or destructor function, define or `=delete` them all
...
To prevent slicing as per [(C.67)](/class#Rc-copy-virtual),
...
To avoid the tedium and the possibility of errors, try to follow the [(rule of zero)](/class#Rc-zero).

##### Enforcement

(Simple) A class should have a declaration (even a `=delete` one) for either all or none of the copy/move/destructor functions.

### <a href="#" name="Rc-matched"></a>C.22: Make default operations consistent
...
## <a href="#" name="SS-dtor"></a>C.dtor: Destructors

"Does this class need a destructor?" is a surprisingly insightful design question.
For most classes the answer is "no" either because the class holds no resources or because destruction is handled by [(the rule of zero)](/class#Rc-zero);
that is, its members can take care of themselves as concerns destruction.
If the answer is "yes", much of the design of the class follows (see [(the rule of five)](/class#Rc-five)).

### <a href="#" name="Rc-dtor"></a>C.30: Define a destructor if a class needs an explicit action at object destruction
...
### <a href="#" name="Rc-dtor-release"></a>C.31: All resources acquired by a class must be released by the class's destructor
...
What about a socket that won't close? A destructor, close, or cleanup operation [(should never fail)](/class#Rc-dtor-fail).
...
See [(discussion)](/discussion#Sd-never-fail).
...
### <a href="#" name="Rc-dtor-ptr"></a>C.32: If a class has a raw pointer (`T*`) or reference (`T&`), consider whether it might be owning
...
Ownership should be clear in new code (and refactored legacy code) according to [(R.20)](/resource#Rr-owner) for owning
pointers and [((R.3)](/resource#Rr-ptr) for non-owning pointers.  References should never own [R.4)](/resource#Rr-ref).

##### Enforcement

Look at the initialization of raw member pointers and member references and see if an allocation is used.

### <a href="#" name="Rc-dtor-ptr2"></a>C.33: If a class has an owning pointer member, define a destructor
...
[(A `T*` should not do so)](/resource#Rr-ptr), but in older code, that's common.
...
Note that if you define a destructor, you must define or delete [(all default operations)](/class#Rc-five):
...
### <a href="#" name="Rc-dtor-virtual"></a>C.35: A base class destructor should be either public and virtual, or protected and non-virtual
...
See [(this in the Discussion section)](/discussion#Sd-dtor).
...
### <a href="#" name="Rc-dtor-fail"></a>C.36: A destructor must not fail
...
### <a href="#" name="Rc-dtor-noexcept"></a>C.37: Make destructors `noexcept`

##### Reason

[(A destructor must not fail)](/class#Rc-dtor-fail). If a destructor tries to exit with an exception, it's a bad design error and the program had better terminate.
...
## <a href="#" name="SS-ctor"></a>C.ctor: Constructors

A constructor defines how an object is initialized (constructed).

### <a href="#" name="Rc-ctor"></a>C.40: Define a constructor if a class has an invariant
...
Also, the default for `int` would be better done as a [(member initializer)](/class#Rc-in-class-initializer).

**See also**: [((construct valid object)](/class#Rc-complete) and [constructor throws)](/class#Rc-throw).
...
### <a href="#" name="Rc-complete"></a>C.41: A constructor should create a fully initialized object
...
If a valid object cannot conveniently be constructed by a constructor, [(use a factory function)](/class#Rc-factory).
...
If a constructor acquires a resource (to create a valid object), that resource should be [(released by the destructor)](/class#Rc-dtor-release).
The idiom of having constructors acquire resources and destructors release them is called [(RAII)](/resource#Rr-raii) ("Resource Acquisition Is Initialization").

### <a href="#" name="Rc-throw"></a>C.42: If a constructor cannot construct a valid object, throw an exception
...
There the `is_valid()` technique must be used. In such cases, check `is_valid()` consistently and immediately to simulate [(RAII)](/resource#Rr-raii).

##### Alternative

If you feel tempted to use some "post-constructor initialization" or "two-stage initialization" idiom, try not to do that.
If you really have to, look at [(factory functions)](/class#Rc-factory).
...
[((Delegating constructors)](/class#Rc-delegating) and [default member initialization)](/class#Rc-in-class-initializer) do that better.
Another reason has been to delay initialization until an object is needed; the solution to that is often [(not to declare a variable until it can be properly initialized)](/expr#Res-init)

##### Enforcement

???

### <a href="#" name="Rc-default0"></a>C.43: Ensure that a copyable class has a default constructor
...
### <a href="#" name="Rc-default00"></a>C.44: Prefer default constructors to be simple and non-throwing
...
### <a href="#" name="Rc-default"></a>C.45: Don't define a default constructor that only initializes data members; use in-class member initializers instead
...
### <a href="#" name="Rc-explicit"></a>C.46: By default, declare single-argument constructors explicit
...
**See also**: [(Discussion of implicit conversions)](/class#Ro-conversion)
...
### <a href="#" name="Rc-order"></a>C.47: Define and initialize member variables in the order of member declaration
...
**See also**: [(Discussion)](/discussion#Sd-order)

### <a href="#" name="Rc-in-class-initializer"></a>C.48: Prefer in-class initializers to member initializers in constructors for constant initializers
...
### <a href="#" name="Rc-initialize"></a>C.49: Prefer initialization to assignment in constructors
...
as [(a more general way to present arguments to a function)](/stdlib#Rstr-view):
...
### <a href="#" name="Rc-factory"></a>C.50: Use a factory function if you need "virtual behavior" during initialization
...
**See also**: [(Discussion)](/discussion#Sd-factory)

### <a href="#" name="Rc-delegating"></a>C.51: Use delegating constructors to represent common actions for all constructors of a class
...
**See also**: If the "repeated action" is a simple initialization, consider [(an in-class member initializer)](/class#Rc-in-class-initializer).

##### Enforcement

(Moderate) Look for similar constructor bodies.

### <a href="#" name="Rc-inheriting"></a>C.52: Use inheriting constructors to import constructors into a derived class that does not need further explicit initialization
...
## <a href="#" name="SS-copy"></a>C.copy: Copy and move
...
### <a href="#" name="Rc-copy-assignment"></a>C.60: Make copy assignment non-`virtual`, take the parameter by `const&`, and return by non-`const&`

##### Reason

It is simple and efficient. If you want to optimize for rvalues, provide an overload that takes a `&&` (see [(F.18)](/functions#Rf-consume)).
...
The `swap` implementation technique offers the [(strong guarantee)](/unclassified#Abrahams01).
...
By writing directly to the target elements, we will get only [((the basic guarantee)](/unclassified#Abrahams01) rather than the strong guarantee offered by the `swap` technique. Beware of [self-assignment)](/class#Rc-copy-self).
...
See [(copy constructor vs. `clone()`)](/class#Rc-copy-virtual).
...
### <a href="#" name="Rc-copy-semantic"></a>C.61: A copy operation should copy
...
### <a href="#" name="Rc-copy-self"></a>C.62: Make copy assignment safe for self-assignment
...
You can handle self-assignment by explicitly testing for self-assignment, but often it is faster and more elegant to cope without such a test (e.g., [(using `swap`)](/class#Rc-swap)).
...
### <a href="#" name="Rc-move-assignment"></a>C.63: Make move assignment non-`virtual`, take the parameter by `&&`, and return by non-`const&`

##### Reason

It is simple and efficient.

**See**: [(The rule for copy-assignment)](/class#Rc-copy-assignment).

##### Enforcement

Equivalent to what is done for [(copy-assignment)](/class#Rc-copy-assignment).

* (Simple) An assignment operator should not be virtual. Here be dragons!
* (Simple) An assignment operator should return `T&` to enable chaining, not alternatives like `const T&` which interfere with composability and putting objects in containers.
* (Moderate) A move assignment operator should (implicitly or explicitly) invoke all base and member move assignment operators.

### <a href="#" name="Rc-move-semantic"></a>C.64: A move operation should move and leave its source in a valid state
...
### <a href="#" name="Rc-move-self"></a>C.65: Make move assignment safe for self-assignment
...
The one-in-a-million argument against `if (this == &a) return *this;` tests from the discussion of [(self-assignment)](/class#Rc-copy-self) is even more relevant for self-move.
...
### <a href="#" name="Rc-move-noexcept"></a>C.66: Make move operations `noexcept`
...
### <a href="#" name="Rc-copy-virtual"></a>C.67: A polymorphic class should suppress public copy/move
...
If you need to create deep copies of polymorphic objects, use `clone()` functions: see [(C.130)](/class#Rh-copy).
...
### <a href="#" name="Rc-eqdefault"></a>C.80: Use `=default` if you have to be explicit about using the default semantics
...
### <a href="#" name="Rc-delete"></a>C.81: Use `=delete` when you want to disable default behavior (without wanting an alternative)
...
### <a href="#" name="Rc-ctor-virtual"></a>C.82: Don't call virtual functions in constructors and destructors
...
**See also** [(factory functions)](/class#Rc-factory) for how to achieve the effect of a call to a derived class function without risking undefined behavior.
...
### <a href="#" name="Rc-swap-fail"></a>C.84: A `swap` function must not fail
...
### <a href="#" name="Rc-swap-noexcept"></a>C.85: Make `swap` `noexcept`

##### Reason

[(A `swap` must not fail)](/class#Rc-swap-fail).
...
### <a href="#" name="Rc-eq"></a>C.86: Make `==` symmetric with respect to operand types and `noexcept`
...
### <a href="#" name="Rc-eq-base"></a>C.87: Beware of `==` on base classes
...
### <a href="#" name="Rc-hash"></a>C.89: Make a `hash` `noexcept`
...
### <a href="#" name="Rc-memset"></a>C.90: Rely on constructors and assignment operators, not `memset` and `memcpy`

##### Reason

The standard C++ mechanism to construct an instance of a type is to call its constructor. As specified in guideline [(C.41)](/class#Rc-complete): a constructor should create a fully initialized object. No additional initialization, such as by `memcpy`, should be required.
...
## <a href="#" name="SS-containers"></a>C.con: Containers and other resource handles
...
* [(C.100: Follow the STL when defining a container)](/class#Rcon-stl)
* [(C.101: Give a container value semantics)](/class#Rcon-val)
* [(C.102: Give a container move operations)](/class#Rcon-move)
* [(C.103: Give a container an initializer list constructor)](/class#Rcon-init)
* [(C.104: Give a container a default constructor that sets it to empty)](/class#Rcon-empty)
* ???
* [(C.109: If a resource handle has pointer semantics, provide `*` and `->`)](/class#Rcon-ptr)

**See also**: [(Resources)](/resource#S-resource)

### <a href="#" name="Rcon-stl"></a>C.100: Follow the STL when defining a container
...
### <a href="#" name="Rcon-val"></a>C.101: Give a container value semantics
...
### <a href="#" name="Rcon-move"></a>C.102: Give a container move operations
...
### <a href="#" name="Rcon-init"></a>C.103: Give a container an initializer list constructor
...
### <a href="#" name="Rcon-empty"></a>C.104: Give a container a default constructor that sets it to empty
...
### <a href="#" name="Rcon-ptr"></a>C.109: If a resource handle has pointer semantics, provide `*` and `->`
...
## <a href="#" name="SS-lambdas"></a>C.lambdas: Function objects and lambdas
...
Function objects should be cheap to copy (and therefore [(passed by value)](/functions#Rf-in)).

Summary:

* [(F.50: Use a lambda when a function won't do (to capture local variables, or to write a local function))](/functions#Rf-capture-vs-overload)
* [(F.52: Prefer capturing by reference in lambdas that will be used locally, including passed to algorithms)](/functions#Rf-reference-capture)
* [(F.53: Avoid capturing by reference in lambdas that will be used non-locally, including returned, stored on the heap, or passed to another thread)](/functions#Rf-value-capture)
* [(ES.28: Use lambdas for complex initialization, especially of `const` variables)](/expr#Res-lambda-init)

## <a href="#" name="SS-hier"></a>C.hier: Class hierarchies (OOP)
...
* [(C.120: Use class hierarchies to represent concepts with inherent hierarchical structure (only))](/class#Rh-domain)
* [(C.121: If a base class is used as an interface, make it a pure abstract class)](/class#Rh-abstract)
* [(C.122: Use abstract classes as interfaces when complete separation of interface and implementation is needed)](/class#Rh-separation)

Designing rules for classes in a hierarchy summary:

* [(C.126: An abstract class typically doesn't need a user-written constructor)](/class#Rh-abstract-ctor)
* [(C.127: A class with a virtual function should have a virtual or protected destructor)](/class#Rh-dtor)
* [(C.128: Virtual functions should specify exactly one of `virtual`, `override`, or `final`)](/class#Rh-override)
* [(C.129: When designing a class hierarchy, distinguish between implementation inheritance and interface inheritance)](/class#Rh-kind)
* [(C.130: For making deep copies of polymorphic classes prefer a virtual `clone` function instead of public copy construction/assignment)](/class#Rh-copy)
* [(C.131: Avoid trivial getters and setters)](/class#Rh-get)
* [(C.132: Don't make a function `virtual` without reason)](/class#Rh-virtual)
* [(C.133: Avoid `protected` data)](/class#Rh-protected)
* [(C.134: Ensure all non-`const` data members have the same access level)](/class#Rh-public)
* [(C.135: Use multiple inheritance to represent multiple distinct interfaces)](/class#Rh-mi-interface)
* [(C.136: Use multiple inheritance to represent the union of implementation attributes)](/class#Rh-mi-implementation)
* [(C.137: Use `virtual` bases to avoid overly general base classes)](/class#Rh-vbase)
* [(C.138: Create an overload set for a derived class and its bases with `using`)](/class#Rh-using)
* [(C.139: Use `final` on classes sparingly)](/class#Rh-final)
* [(C.140: Do not provide different default arguments for a virtual function and an overrider)](/class#Rh-virtual-default-arg)

Accessing objects in a hierarchy rule summary:

* [(C.145: Access polymorphic objects through pointers and references)](/class#Rh-poly)
* [C.146: Use `dynamic_cast` where class hierarchy navigation is unavoidable](#Rh-dynamic_cast)
* [(C.147: Use `dynamic_cast` to a reference type when failure to find the required class is considered an error)](/class#Rh-ref-cast)
* [(C.148: Use `dynamic_cast` to a pointer type when failure to find the required class is considered a valid alternative)](/class#Rh-ptr-cast)
* [(C.149: Use `unique_ptr` or `shared_ptr` to avoid forgetting to `delete` objects created using `new`)](/class#Rh-smart)
...
* [(C.152: Never assign a pointer to an array of derived class objects to a pointer to its base)](/class#Rh-array)
* [(C.153: Prefer virtual function to casting)](/class#Rh-use-virtual)

### <a href="#" name="Rh-domain"></a>C.120: Use class hierarchies to represent concepts with inherent hierarchical structure (only)
...
### <a href="#" name="Rh-abstract"></a>C.121: If a base class is used as an interface, make it a pure abstract class
...
### <a href="#" name="Rh-separation"></a>C.122: Use abstract classes as interfaces when complete separation of interface and implementation is needed
...
### <a href="#" name="Rh-abstract-ctor"></a>C.126: An abstract class typically doesn't need a user-written constructor
...
### <a href="#" name="Rh-override"></a>C.128: Virtual functions should specify exactly one of `virtual`, `override`, or `final`
...
### <a href="#" name="Rh-kind"></a>C.129: When designing a class hierarchy, distinguish between implementation inheritance and interface inheritance
...
A pure interface class is simply a set of pure virtual functions; see [(I.25)](/interfaces#Ri-abstract).
...
Another (related) technique for separating interface and implementation is [(Pimpl)](/interfaces#Ri-pimpl).
...
### <a href="#" name="Rh-copy"></a>C.130: For making deep copies of polymorphic classes prefer a virtual `clone` function instead of public copy construction/assignment

##### Reason

Copying a polymorphic class is discouraged due to the slicing problem, see [(C.67)](/class#Rc-copy-virtual). If you really need copy semantics, copy deeply: Provide a virtual `clone` function that will copy the actual most-derived type and return an owning pointer to the new object, and then in derived classes return the derived type (use a covariant return type).
...
Generally, it is recommended to use smart pointers to represent ownership (see [((R.20)](/resource#Rr-owner)). However, because of language rules, the covariant return type cannot be a smart pointer: `D::clone` can't return a `unique_ptr<D>` while `B::clone` returns `unique_ptr<B>`. Therefore, you either need to consistently return `unique_ptr<B>` in all overrides, or use `owner<>` utility from the [Guidelines Support Library)](/gsl#SS-views).

### <a href="#" name="Rh-get"></a>C.131: Avoid trivial getters and setters
...
Note that we can put default initializers on member variables: [(C.49: Prefer initialization to assignment in constructors)](/class#Rc-initialize).
...
### <a href="#" name="Rh-virtual"></a>C.132: Don't make a function `virtual` without reason
...
### <a href="#" name="Rh-protected"></a>C.133: Avoid `protected` data
...
[(Prefer `private` data)](/class#Rc-private) with a well-specified and enforced invariant.
Alternative, and often better, [(keep data out of any class used as an interface)](/class#Rh-abstract).
...
### <a href="#" name="Rh-public"></a>C.134: Ensure all non-`const` data members have the same access level
...
* *All public*: If you're writing an aggregate bundle-of-variables without an invariant across those variables, then all the variables should be `public`.
  [(By convention, declare such classes `struct` rather than `class`)](/class#Rc-struct)
...
### <a href="#" name="Rh-mi-interface"></a>C.135: Use multiple inheritance to represent multiple distinct interfaces
...
### <a href="#" name="Rh-mi-implementation"></a>C.136: Use multiple inheritance to represent the union of implementation attributes
...
### <a href="#" name="Rh-vbase"></a>C.137: Use `virtual` bases to avoid overly general base classes
...
`Interface` is the root of an [(interface hierarchy)](/class#Rh-abstract)
and `Utility` is the root of an [(implementation hierarchy)](/class#Rh-kind).
...
### <a href="#" name="Rh-using"></a>C.138: Create an overload set for a derived class and its bases with `using`
...
### <a href="#" name="Rh-final"></a>C.139: Use `final` on classes sparingly
...
### <a href="#" name="Rh-virtual-default-arg"></a>C.140: Do not provide different default arguments for a virtual function and an overrider
...
### <a href="#" name="Rh-poly"></a>C.145: Access polymorphic objects through pointers and references
...
[(A polymorphic class should suppress copying)](/class#Rc-copy-virtual)

##### Enforcement

Flag all slicing.

### <a href="#" name="Rh-dynamic_cast"></a>C.146: Use `dynamic_cast` where class hierarchy navigation is unavoidable
...
[(Prefer virtual functions to casting)](/class#Rh-use-virtual).
...
* This rule is part of the [(type-safety profile)](/profile#Pro-type-downcast).

### <a href="#" name="Rh-ref-cast"></a>C.147: Use `dynamic_cast` to a reference type when failure to find the required class is considered an error
...
### <a href="#" name="Rh-ptr-cast"></a>C.148: Use `dynamic_cast` to a pointer type when failure to find the required class is considered a valid alternative
...
Contrast with [(C.147)](/class#Rh-ref-cast), where failure is an error, and should not be used for conditional execution.
...
### <a href="#" name="Rh-smart"></a>C.149: Use `unique_ptr` or `shared_ptr` to avoid forgetting to `delete` objects created using `new`
...
### <a href="#" name="Rh-make_unique"></a>C.150: Use `make_unique()` to construct objects owned by `unique_ptr`s

See [R.23](#Rr-make_unique)

### <a href="#" name="Rh-make_shared"></a>C.151: Use `make_shared()` to construct objects owned by `shared_ptr`s

See [R.22](#Rr-make_shared)

### <a href="#" name="Rh-array"></a>C.152: Never assign a pointer to an array of derived class objects to a pointer to its base
...
### <a href="#" name="Rh-use-virtual"></a>C.153: Prefer virtual function to casting
...
## <a href="#" name="SS-overload"></a>C.over: Overloading and overloaded operators
...
* [(C.160: Define operators primarily to mimic conventional usage)](/class#Ro-conventional)
* [(C.161: Use non-member functions for symmetric operators)](/class#Ro-symmetric)
* [(C.162: Overload operations that are roughly equivalent)](/class#Ro-equivalent)
* [(C.163: Overload only for operations that are roughly equivalent)](/class#Ro-equivalent-2)
* [(C.164: Avoid implicit conversion operators)](/class#Ro-conversion)
* [(C.165: Use `using` for customization points)](/class#Ro-custom)
* [(C.166: Overload unary `&` only as part of a system of smart pointers and references)](/class#Ro-address-of)
* [(C.167: Use an operator for an operation with its conventional meaning)](/class#Ro-overload)
* [(C.168: Define overloaded operators in the namespace of their operands)](/class#Ro-namespace)
* [(C.170: If you feel like overloading a lambda, use a generic lambda)](/class#Ro-lambda)

### <a href="#" name="Ro-conventional"></a>C.160: Define operators primarily to mimic conventional usage
...
Here, the conventional semantics is maintained: [(Copies compare equal)](/class#SS-copy).
...
Non-member operators should be either friends or defined in [(the same namespace as their operands)](/class#Ro-namespace).
[(Binary operators should treat their operands equivalently)](/class#Ro-symmetric).

##### Enforcement

Possibly impossible.

### <a href="#" name="Ro-symmetric"></a>C.161: Use non-member functions for symmetric operators
...
### <a href="#" name="Ro-equivalent"></a>C.162: Overload operations that are roughly equivalent
...
### <a href="#" name="Ro-equivalent-2"></a>C.163: Overload only for operations that are roughly equivalent
...
### <a href="#" name="Ro-conversion"></a>C.164: Avoid implicit conversion operators
...
### <a href="#" name="Ro-custom"></a>C.165: Use `using` for customization points
...
### <a href="#" name="Ro-address-of"></a>C.166: Overload unary `&` only as part of a system of smart pointers and references
...
### <a href="#" name="Ro-overload"></a>C.167: Use an operator for an operation with its conventional meaning
...
### <a href="#" name="Ro-namespace"></a>C.168: Define overloaded operators in the namespace of their operands
...
This is a special case of the rule that [(helper functions should be defined in the same namespace as their class)](/class#Rc-helper).

##### Enforcement

* Flag operator definitions that are not in the namespace of their operands

### <a href="#" name="Ro-lambda"></a>C.170: If you feel like overloading a lambda, use a generic lambda
...
## <a href="#" name="SS-union"></a>C.union: Unions
...
* [(C.180: Use `union`s to save Memory)](/class#Ru-union)
* [(C.181: Avoid "naked" `union`s)](/class#Ru-naked)
* [(C.182: Use anonymous `union`s to implement tagged unions)](/class#Ru-anonymous)
* [(C.183: Don't use a `union` for type punning)](/class#Ru-pun)
* ???

### <a href="#" name="Ru-union"></a>C.180: Use `union`s to save memory
...
But heed the warning: [(Avoid "naked" `union`s)](/class#Ru-naked)
...
### <a href="#" name="Ru-naked"></a>C.181: Avoid "naked" `union`s
...
### <a href="#" name="Ru-anonymous"></a>C.182: Use anonymous `union`s to implement tagged unions
...
### <a href="#" name="Ru-pun"></a>C.183: Don't use a `union` for type punning
