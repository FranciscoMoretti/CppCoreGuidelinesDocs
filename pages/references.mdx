# <a href="#" name="S-references"></a>RF: References
...
* [RF.rules: Coding rules](/references#SS-rules)

* [RF.books: Books with coding guidelines](/references#SS-books)

* [RF.C++: C++ Programming (C++11/C++14/C++17)](/references#SS-Cplusplus)

* [RF.web: Websites](/references#SS-web)

* [RS.video: Videos about "modern C++"](/references#SS-vid)

* [RF.man: Manuals](/references#SS-man)

* [RF.core: Core Guidelines materials](/references#SS-core)


## <a href="#" name="SS-rules"></a>RF.rules: Coding rules
...
## <a href="#" name="SS-books"></a>RF.books: Books with coding guidelines

* [Meyers96](/unclassified#Meyers96) Scott Meyers: *More Effective C++*. Addison-Wesley 1996.

* [Meyers97](/unclassified#Meyers97) Scott Meyers: *Effective C++, Second Edition*. Addison-Wesley 1997.

* [Meyers01](/unclassified#Meyers01) Scott Meyers: *Effective STL*. Addison-Wesley 2001.

* [Meyers05](/unclassified#Meyers05) Scott Meyers: *Effective C++, Third Edition*. Addison-Wesley 2005.

* [Meyers15](/unclassified#Meyers15) Scott Meyers: *Effective Modern C++*. O'Reilly 2015.

* [SuttAlex05](/unclassified#SuttAlex05) Sutter and Alexandrescu: *C++ Coding Standards*. Addison-Wesley 2005. More a set of meta-rules than a set of rules. Pre-C++11.

* [Stroustrup05](/unclassified#Stroustrup05) Bjarne Stroustrup: [A rationale for semantically enhanced library languages](http://www.stroustrup.com/SELLrationale.pdf).

  LCSD05. October 2005.
* [Stroustrup14](/unclassified#Stroustrup05) Stroustrup: [A Tour of C++](http://www.stroustrup.com/Tour.html).

  Addison Wesley 2014.
  Each chapter ends with an advice section consisting of a set of recommendations.
* [Stroustrup13](/unclassified#Stroustrup13) Stroustrup: [The C++ Programming Language (4th Edition)](http://www.stroustrup.com/4th.html).
...
## <a href="#" name="SS-Cplusplus"></a>RF.C++: C++ Programming (C++11/C++14)
...
## <a href="#" name="SS-man"></a>RF.man: Manuals
...
## <a href="#" name="SS-core"></a>RF.core: Core Guidelines materials
...
## <a href="#" name="SS-ack"></a>Acknowledgements
