...
* [In.target: Target readership](/introduction#SS-readers)

* [In.aims: Aims](/introduction#SS-aims)

* [In.not: Non-aims](/introduction#SS-non)

* [In.force: Enforcement](/introduction#SS-force)

* [In.struct: The structure of this document](/introduction#SS-struct)

* [In.sec: Major sections](/introduction#SS-sec)


## <a name="SS-readers"></a>In.target: Target readership

All C++ programmers. This includes [programmers who might consider C](/cpl#S-cpl).
...
These guidelines are designed according to the "subset of superset" principle ([Stroustrup05](/stdlib#Stroustrup05)).

They do not simply define a subset of C++ to be used (for reliability, safety, performance, or whatever).
Instead, they strongly recommend the use of a few simple "extensions" ([library components](/stdlib#S-gsl))
...
The rules are designed to allow [gradual adoption](/stdlib#S-modernizing).
...
If you need a tutorial for some given level of experience, see [the references](/stdlib#S-references).
...
However, see [the modernization section](/stdlib#S-modernizing) for some possible approaches to modernizing/rejuvenating/upgrading.
...
* `tag` is the anchor name of the item where the Enforcement rule appears (e.g., for [C.134](/class#Rh-public) it is "Rh-public"), the

name of a profile group-of-rules ("type", "bounds", or "lifetime"),
or a specific rule in a profile ([type.4](/stdlib#Pro-type-cstylecast), or [bounds.2](/stdlib#Pro-bounds-arrayindex))
...
Such information is found in the **Alternative** paragraphs and the [Discussion](/stdlib#S-discussion) sections.
...
Recommended information sources can be found in [the references](/stdlib#S-references).
...
* [A: Architectural ideas](/stdlib#S-A)

* [NR: Non-Rules and myths](/stdlib#S-not)

* [RF: References](/stdlib#S-references)

* [Pro: Profiles](/stdlib#S-profile)

* [GSL: Guidelines support library](/stdlib#S-gsl)

* [NL: Naming and layout suggestions](/stdlib#S-naming)

* [FAQ: Answers to frequently asked questions](/stdlib#S-faq)

* [Appendix A: Libraries](/stdlib#S-libraries)

* [Appendix B: Modernizing code](/stdlib#S-modernizing)

* [Appendix C: Discussion](/stdlib#S-discussion)

* [Appendix D: Supporting tools](/stdlib#S-tools)

* [Glossary](/stdlib#S-glossary)

* [To-do: Unclassified proto-rules](/stdlib#S-unclassified)
