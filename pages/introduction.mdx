# <a href="#" name="S-introduction"></a>In: Introduction
...
## <a href="#" name="SS-readers"></a>In.target: Target readership

All C++ programmers. This includes [programmers who might consider C](/cpl#S-cpl).


## <a href="#" name="SS-aims"></a>In.aims: Aims
...
### <a href="#" name="R0"></a>In.0: Don't panic!

Take the time to understand the implications of a guideline rule on your program.

These guidelines are designed according to the "subset of superset" principle ([Stroustrup05](/unclassified#Stroustrup05)).

They do not simply define a subset of C++ to be used (for reliability, safety, performance, or whatever).
Instead, they strongly recommend the use of a few simple "extensions" ([library components](/gsl#S-gsl))
...
The rules are designed to allow [gradual adoption](/modernizing#S-modernizing).
...
## <a href="#" name="SS-non"></a>In.not: Non-aims
...
If you need a tutorial for some given level of experience, see [the references](/references#S-references).
...
However, see [the modernization section](/modernizing#S-modernizing) for some possible approaches to modernizing/rejuvenating/upgrading.
...
## <a href="#" name="SS-force"></a>In.force: Enforcement
...
or a specific rule in a profile ([type.4](/profile#Pro-type-cstylecast), or [bounds.2](/profile#Pro-bounds-arrayindex))
...
## <a href="#" name="SS-struct"></a>In.struct: The structure of this document
...
Such information is found in the **Alternative** paragraphs and the [Discussion](/discussion#S-discussion) sections.
...
Recommended information sources can be found in [the references](/references#S-references).


## <a href="#" name="SS-sec"></a>In.sec: Major sections
