# <a href="#" name="S-enum"></a>Enum: Enumerations
...
* [(Enum.1: Prefer enumerations over macros)](/enum#Renum-macro)
* [(Enum.2: Use enumerations to represent sets of related named constants)](/enum#Renum-set)
* [(Enum.3: Prefer `enum class`es over "plain" `enum`s)](/enum#Renum-class)
* [(Enum.4: Define operations on enumerations for safe and simple use)](/enum#Renum-oper)
* [(Enum.5: Don't use `ALL_CAPS` for enumerators)](/enum#Renum-caps)
* [(Enum.6: Avoid unnamed enumerations)](/enum#Renum-unnamed)
* [(Enum.7: Specify the underlying type of an enumeration only when necessary)](/enum#Renum-underlying)
* [(Enum.8: Specify enumerator values only when necessary)](/enum#Renum-value)

### <a href="#" name="Renum-macro"></a>Enum.1: Prefer enumerations over macros
...
### <a href="#" name="Renum-set"></a>Enum.2: Use enumerations to represent sets of related named constants
...
### <a href="#" name="Renum-class"></a>Enum.3: Prefer class enums over "plain" enums
...
### <a href="#" name="Renum-oper"></a>Enum.4: Define operations on enumerations for safe and simple use
...
### <a href="#" name="Renum-caps"></a>Enum.5: Don't use `ALL_CAPS` for enumerators
...
### <a href="#" name="Renum-unnamed"></a>Enum.6: Avoid unnamed enumerations
...
### <a href="#" name="Renum-underlying"></a>Enum.7: Specify the underlying type of an enumeration only when necessary
...
### <a href="#" name="Renum-value"></a>Enum.8: Specify enumerator values only when necessary
