...
* [E.16: Destructors, deallocation, and `swap` must never fail](/errors#Re-never-fail)
...
### <a href="#" name="Re-never-fail"></a>E.16: Destructors, deallocation, and `swap` must never fail
