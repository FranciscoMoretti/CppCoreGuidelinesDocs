...
**See also**: [discussion](/stdlib#Sd-noexcept)
...
**See also**: [discussion](/stdlib#Sd-never-fail)
...
For example, see [Stroustrup94](/stdlib#Stroustrup94).
