# <a href="#" name="S-templates"></a>T: Templates and generic programming
...
* [(T.1: Use templates to raise the level of abstraction of code)](/templates#Rt-raise)
* [(T.2: Use templates to express algorithms that apply to many argument types)](/templates#Rt-algo)
* [(T.3: Use templates to express containers and ranges)](/templates#Rt-cont)
* [(T.4: Use templates to express syntax tree manipulation)](/templates#Rt-expr)
* [(T.5: Combine generic and OO techniques to amplify their strengths, not their costs)](/templates#Rt-generic-oo)

Concept use rule summary:

* [(T.10: Specify concepts for all template arguments)](/templates#Rt-concepts)
* [(T.11: Whenever possible use standard concepts)](/templates#Rt-std-concepts)
* [(T.12: Prefer concept names over `auto` for local variables)](/templates#Rt-auto)
* [(T.13: Prefer the shorthand notation for simple, single-type argument concepts)](/templates#Rt-shorthand)
* ???

Concept definition rule summary:

* [(T.20: Avoid "concepts" without meaningful semantics)](/templates#Rt-low)
* [(T.21: Require a complete set of operations for a concept)](/templates#Rt-complete)
* [(T.22: Specify axioms for concepts)](/templates#Rt-axiom)
* [(T.23: Differentiate a refined concept from its more general case by adding new use patterns)](/templates#Rt-refine)
* [(T.24: Use tag classes or traits to differentiate concepts that differ only in semantics)](/templates#Rt-tag)
* [(T.25: Avoid complementary constraints)](/templates#Rt-not)
* [(T.26: Prefer to define concepts in terms of use-patterns rather than simple syntax)](/templates#Rt-use)
...
* [(T.40: Use function objects to pass operations to algorithms)](/templates#Rt-fo)
* [(T.41: Require only essential properties in a template's concepts)](/templates#Rt-essential)
* [(T.42: Use template aliases to simplify notation and hide implementation details)](/templates#Rt-alias)
* [(T.43: Prefer `using` over `typedef` for defining aliases)](/templates#Rt-using)
* [(T.44: Use function templates to deduce class template argument types (where feasible))](/templates#Rt-deduce)
* [(T.46: Require template arguments to be at least semiregular)](/templates#Rt-regular)
* [(T.47: Avoid highly visible unconstrained templates with common names)](/templates#Rt-visible)
* [(T.48: If your compiler does not support concepts, fake them with `enable_if`)](/templates#Rt-concept-def)
* [(T.49: Where possible, avoid type-erasure)](/templates#Rt-erasure)

Template definition rule summary:

* [(T.60: Minimize a template's context dependencies)](/templates#Rt-depend)
* [(T.61: Do not over-parameterize members (SCARY))](/templates#Rt-scary)
* [(T.62: Place non-dependent class template members in a non-templated base class)](/templates#Rt-nondependent)
* [(T.64: Use specialization to provide alternative implementations of class templates)](/templates#Rt-specialization)
* [(T.65: Use tag dispatch to provide alternative implementations of functions)](/templates#Rt-tag-dispatch)
* [(T.67: Use specialization to provide alternative implementations for irregular types)](/templates#Rt-specialization2)
* [(T.68: Use `{}` rather than `()` within templates to avoid ambiguities)](/templates#Rt-cast)
* [(T.69: Inside a template, don't make an unqualified non-member function call unless you intend it to be a customization point)](/templates#Rt-customization)

Template and hierarchy rule summary:

* [(T.80: Do not naively templatize a class hierarchy)](/templates#Rt-hier)
* [(T.81: Do not mix hierarchies and arrays)](/templates#Rt-array) // ??? somewhere in "hierarchies"
* [(T.82: Linearize a hierarchy when virtual functions are undesirable)](/templates#Rt-linear)
* [(T.83: Do not declare a member function template virtual)](/templates#Rt-virtual)
* [(T.84: Use a non-template core implementation to provide an ABI-stable interface)](/templates#Rt-abi)
* [T.??: ????](#Rt-???)

Variadic template rule summary:

* [(T.100: Use variadic templates when you need a function that takes a variable number of arguments of a variety of types)](/templates#Rt-variadic)
* [(T.101: ??? How to pass arguments to a variadic template ???)](/templates#Rt-variadic-pass)
* [(T.102: ??? How to process arguments to a variadic template ???)](/templates#Rt-variadic-process)
* [(T.103: Don't use variadic templates for homogeneous argument lists)](/templates#Rt-variadic-not)
* [T.??: ????](#Rt-???)

Metaprogramming rule summary:

* [(T.120: Use template metaprogramming only when you really need to)](/templates#Rt-metameta)
* [(T.121: Use template metaprogramming primarily to emulate concepts)](/templates#Rt-emulate)
* [(T.122: Use templates (usually template aliases) to compute types at compile time)](/templates#Rt-tmp)
* [(T.123: Use `constexpr` functions to compute values at compile time)](/templates#Rt-fct)
* [(T.124: Prefer to use standard-library TMP facilities)](/templates#Rt-std-tmp)
* [(T.125: If you need to go beyond the standard-library TMP facilities, use an existing library)](/templates#Rt-lib)
* [T.??: ????](#Rt-???)

Other template rules summary:

* [(T.140: Name all operations with potential for reuse)](/templates#Rt-name)
* [(T.141: Use an unnamed lambda if you need a simple function object in one place only)](/templates#Rt-lambda)
* [(T.142: Use template variables to simplify notation)](/templates#Rt-var)
* [(T.143: Don't write unintentionally non-generic code)](/templates#Rt-non-generic)
* [(T.144: Don't specialize function templates)](/templates#Rt-specialize-function)
* [(T.150: Check that a class matches a concept using `static_assert`)](/templates#Rt-check-class)
* [T.??: ????](#Rt-???)

## <a href="#" name="SS-GP"></a>T.gp: Generic programming

Generic programming is programming using types and algorithms parameterized by types, values, and algorithms.

### <a href="#" name="Rt-raise"></a>T.1: Use templates to raise the level of abstraction of code
...
### <a href="#" name="Rt-algo"></a>T.2: Use templates to express algorithms that apply to many argument types
...
### <a href="#" name="Rt-cont"></a>T.3: Use templates to express containers and ranges
...
See [(Stable base)](/templates#Rt-abi).

##### Enforcement

* Flag uses of `void*`s and casts outside low-level implementation code

### <a href="#" name="Rt-expr"></a>T.4: Use templates to express syntax tree manipulation
...
### <a href="#" name="Rt-generic-oo"></a>T.5: Combine generic and OO techniques to amplify their strengths, not their costs
...
Examples include type erasure as with `std::shared_ptr`'s deleter (but [(don't overuse type erasure)](/templates#Rt-erasure)).
...
## <a href="#" name="SS-concepts"></a>T.concepts: Concept rules
...
* [(T.10: Specify concepts for all template arguments)](/templates#Rt-concepts)
* [(T.11: Whenever possible use standard concepts)](/templates#Rt-std-concepts)
* [(T.12: Prefer concept names over `auto`)](/templates#Rt-auto)
* [(T.13: Prefer the shorthand notation for simple, single-type argument concepts)](/templates#Rt-shorthand)
* ???
...
* [(T.23: Differentiate a refined concept from its more general case by adding new use patterns)](/templates#Rt-refine)
* [(T.24: Use tag classes or traits to differentiate concepts that differ only in semantics)](/templates#Rt-tag)
* [(T.25: Avoid complimentary constraints)](/templates#Rt-not)
* [(T.26: Prefer to define concepts in terms of use-patterns rather than simple syntax)](/templates#Rt-use)
* ???

## <a href="#" name="SS-concept-use"></a>T.con-use: Concept use

### <a href="#" name="Rt-concepts"></a>T.10: Specify concepts for all template arguments
...
### <a href="#" name="Rt-std-concepts"></a>T.11: Whenever possible use standard concepts

##### Reason

"Standard" concepts (as provided by the [(GSL)](/gsl#S-gsl) and the ISO standard itself)
...
### <a href="#" name="Rt-auto"></a>T.12: Prefer concept names over `auto` for local variables
...
### <a href="#" name="Rt-shorthand"></a>T.13: Prefer the shorthand notation for simple, single-type argument concepts
...
## <a href="#" name="SS-concepts-def"></a>T.concepts.def: Concept definition rules
...
### <a href="#" name="Rt-low"></a>T.20: Avoid "concepts" without meaningful semantics
...
### <a href="#" name="Rt-complete"></a>T.21: Require a complete set of operations for a concept
...
This is a specific variant of the general rule that [(a concept must make semantic sense)](/templates#Rt-low).
...
### <a href="#" name="Rt-axiom"></a>T.22: Specify axioms for concepts
...
See the [(Palo Alto TR)](/references#S-references) for examples.
...
### <a href="#" name="Rt-refine"></a>T.23: Differentiate a refined concept from its more general case by adding new use patterns.
...
* Flag a concept that has exactly the same requirements as another already-seen concept (neither is more refined).
  To disambiguate them, see [(T.24)](/templates#Rt-tag).

### <a href="#" name="Rt-tag"></a>T.24: Use tag classes or traits to differentiate concepts that differ only in semantics.
...
### <a href="#" name="Rt-not"></a>T.25: Avoid complementary constraints
...
### <a href="#" name="Rt-use"></a>T.26: Prefer to define concepts in terms of use-patterns rather than simple syntax
...
## <a href="#" name="SS-temp-interface"></a>Template interfaces
...
### <a href="#" name="Rt-fo"></a>T.40: Use function objects to pass operations to algorithms
...
### <a href="#" name="Rt-essential"></a>T.41: Require only essential properties in a template's concepts
...
### <a href="#" name="Rt-alias"></a>T.42: Use template aliases to simplify notation and hide implementation details
...
### <a href="#" name="Rt-using"></a>T.43: Prefer `using` over `typedef` for defining aliases
...
### <a href="#" name="Rt-deduce"></a>T.44: Use function templates to deduce class template argument types (where feasible)
...
### <a href="#" name="Rt-regular"></a>T.46: Require template arguments to be at least semiregular
...
### <a href="#" name="Rt-visible"></a>T.47: Avoid highly visible unconstrained templates with common names
...
### <a href="#" name="Rt-concept-def"></a>T.48: If your compiler does not support concepts, fake them with `enable_if`
...
Beware of [(complementary constraints)](/templates#Rt-not).
...
### <a href="#" name="Rt-erasure"></a>T.49: Where possible, avoid type-erasure
...
## <a href="#" name="SS-temp-def"></a>T.def: Template definitions
...
### <a href="#" name="Rt-depend"></a>T.60: Minimize a template's context dependencies
...
**See also**: [(T.69)](/templates#Rt-customization)

##### Enforcement

??? Tricky

### <a href="#" name="Rt-scary"></a>T.61: Do not over-parameterize members (SCARY)
...
### <a href="#" name="Rt-nondependent"></a>T.62: Place non-dependent class template members in a non-templated base class
...
For N == 1, we have a choice of a base class of a class in the surrounding scope as in [(T.61)](/templates#Rt-scary).
...
### <a href="#" name="Rt-specialization"></a>T.64: Use specialization to provide alternative implementations of class templates
...
### <a href="#" name="Rt-tag-dispatch"></a>T.65: Use tag dispatch to provide alternative implementations of a function
...
### <a href="#" name="Rt-specialization2"></a>T.67: Use specialization to provide alternative implementations for irregular types
...
### <a href="#" name="Rt-cast"></a>T.68: Use `{}` rather than `()` within templates to avoid ambiguities
...
### <a href="#" name="Rt-customization"></a>T.69: Inside a template, don't make an unqualified non-member function call unless you intend it to be a customization point
...
this can cause problems like [(unintentionally invoking unconstrained function templates)](/templates#Rt-visible).
...
## <a href="#" name="SS-temp-hier"></a>T.temp-hier: Template and hierarchy rules:
...
### <a href="#" name="Rt-hier"></a>T.80: Do not naively templatize a class hierarchy
...
see [(("stable base")](/templates#Rt-abi) and [OO and GP)](/templates#Rt-generic-oo)

##### Enforcement

* Flag virtual functions that depend on a template argument. ??? False positives

### <a href="#" name="Rt-array"></a>T.81: Do not mix hierarchies and arrays
...
Note that `maul()` violates the a [(`T*` points to an individual object rule)](/functions#Rf-ptr).
...
Note that the assignment in `maul2()` violated the [(no-slicing rule)](/expr#Res-slice).

##### Enforcement

* Detect this horror!

### <a href="#" name="Rt-linear"></a>T.82: Linearize a hierarchy when virtual functions are undesirable
...
### <a href="#" name="Rt-virtual"></a>T.83: Do not declare a member function template virtual
...
### <a href="#" name="Rt-abi"></a>T.84: Use a non-template core implementation to provide an ABI-stable interface
...
**Alternative**: Use a [(Pimpl)](/interfaces#Ri-pimpl) implementation.

##### Enforcement

???

## <a href="#" name="SS-variadic"></a>T.var: Variadic template rules

???

### <a href="#" name="Rt-variadic"></a>T.100: Use variadic templates when you need a function that takes a variable number of arguments of a variety of types
...
### <a href="#" name="Rt-variadic-pass"></a>T.101: ??? How to pass arguments to a variadic template ???
...
### <a href="#" name="Rt-variadic-process"></a>T.102: How to process arguments to a variadic template
...
### <a href="#" name="Rt-variadic-not"></a>T.103: Don't use variadic templates for homogeneous argument lists
...
## <a href="#" name="SS-meta"></a>T.meta: Template metaprogramming (TMP)
...
### <a href="#" name="Rt-metameta"></a>T.120: Use template metaprogramming only when you really need to
...
Instead, use concepts. But see [(How to emulate concepts if you don't have language support)](/templates#Rt-emulate).
...
**Alternative**: If the result is a value, rather than a type, use a [(`constexpr` function)](/templates#Rt-fct).

##### Note

If you feel the need to hide your template metaprogramming in macros, you have probably gone too far.

### <a href="#" name="Rt-emulate"></a>T.121: Use template metaprogramming primarily to emulate concepts
...
### <a href="#" name="Rt-tmp"></a>T.122: Use templates (usually template aliases) to compute types at compile time
...
### <a href="#" name="Rt-fct"></a>T.123: Use `constexpr` functions to compute values at compile time
...
### <a href="#" name="Rt-std-tmp"></a>T.124: Prefer to use standard-library TMP facilities
...
### <a href="#" name="Rt-lib"></a>T.125: If you need to go beyond the standard-library TMP facilities, use an existing library
...
## <a href="#" name="SS-temp-other"></a>Other template rules

### <a href="#" name="Rt-name"></a>T.140: Name all operations with potential for reuse
...
### <a href="#" name="Rt-lambda"></a>T.141: Use an unnamed lambda if you need a simple function object in one place only
...
### <a href="#" name="Rt-var"></a>T.142?: Use template variables to simplify notation
...
### <a href="#" name="Rt-non-generic"></a>T.143: Don't write unintentionally non-generic code
...
### <a href="#" name="Rt-specialize-function"></a>T.144: Don't specialize function templates
...
### <a href="#" name="Rt-check-class"></a>T.150: Check that a class matches a concept using `static_assert`
