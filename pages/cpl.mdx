# <a href="#" name="S-cpl"></a>CPL: C-style programming
...
* [CPL.1: Prefer C++ to C](/cpl#Rcpl-C)

* [CPL.2: If you must use C, use the common subset of C and C++, and compile the C code as C++](/cpl#Rcpl-subset)

* [CPL.3: If you must use C for interfaces, use C++ in the calling code using such interfaces](/cpl#Rcpl-interface)


### <a href="#" name="Rcpl-C"></a>CPL.1: Prefer C++ to C
...
### <a href="#" name="Rcpl-subset"></a>CPL.2: If you must use C, use the common subset of C and C++, and compile the C code as C++
...
### <a href="#" name="Rcpl-interface"></a>CPL.3: If you must use C for interfaces, use C++ in the calling code using such interfaces
